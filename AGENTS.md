...
- The UI uses shadcn/ui-style primitives built on Base UI (`@base-ui-components/react`) + Tailwind CSS, stock neutral theme. Reusable primitives live in `ui/src/components/ui/`; compose them and style with Tailwind utility classes. Reach for a raw HTML element + Tailwind before adding a new primitive.
...
Reusable primitives live in `ui/src/components/ui/`; compose them with Tailwind
