...
var file_proto_api_proto_depIdxs = []int32{
	...
	2, // 5: ConfigurationProject.protocol:type_name -> RpcProtocol
	3, // 6: Api.Compile:input_type -> CompileRequest
	6, // 7: Api.GetConfiguration:input_type -> GetConfigurationRequest
	4, // 8: Api.Compile:output_type -> CompileResponse
	7, // 9: Api.GetConfiguration:output_type -> GetConfigurationResponse
