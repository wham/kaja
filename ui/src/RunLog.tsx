...
const touchUtilityButtonClass = "h-11 w-9";
...
RunLog.PayloadPane = function ({ methodCall, touch = false, activeTab, embedded, onTabChange, onEmbeddedChange }: PayloadPaneProps) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className={cn("flex shrink-0 items-center overflow-hidden px-3", touch ? "h-11 gap-3 border-b border-border" : "h-[28px] gap-4")}>
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            {embeddable && (
              <IconButton
                ...
                variant="ghost"
                size="sm"
                className={cn(utilityButtonClass, touch && touchUtilityButtonClass, embedded && "bg-accent text-foreground")}
...
RunLog.PayloadTabs = function ({ methodCall, touch = false, activeTab, onTabChange }: PayloadTabsProps) {
  ...
  return (
    <div className={cn("flex shrink-0 items-center", touch ? "gap-3" : "gap-4")}>
      {tab("request", "Request")}
