...
export function GetNodePath():Promise<string>;

export function GetProtocIncludePath():Promise<string>;

export function GetProtocPath():Promise<string>;

export function LoadSourceFile(arg1:string):Promise<string>;
