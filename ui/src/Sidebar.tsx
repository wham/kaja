...
export function Sidebar({ projects, currentMethod, onSelect, onCompilerClick, onAddProjectClick }: SidebarProps) {
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      >
        ...
        {isWailsEnvironment() && onAddProjectClick && (
          <IconButton icon={PlusIcon} size="small" variant="invisible" aria-label="Add Project" onClick={onAddProjectClick} />
        )}
